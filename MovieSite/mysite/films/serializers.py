...
class FilmSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Film
        fields = ['id','name', 'release_date', 'on_netfilx', 'profit', 'rating', 'nr_of_screenings', 'average_pay']
...
class FilmForm(ModelForm):
    ...
    class Meta:
        ...
        fields = ['name', 'release_date', 'on_netfilx', 'profit', 'rating']
...
class FilmScreeningSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Film
        fields = ['name','release_date','on_netfilx','profit','rating', 'screenings']
